# ==========================================
# [중요] 최상단 락 방지 설정 (import chromadb보다 무조건 위에 있어야 함)
# ==========================================
import os
import sys

# 1. 맥북 보안 락(Fork Safety) 강제 해제 (Mutex 에러의 주범)
...
# 3. SQLite 호환성 패치 (시스템 라이브러리 충돌 방지)
try:
    __import__('pysqlite3')
    sys.modules['sqlite3'] = sys.modules.pop('pysqlite3')
except ImportError:
    # pysqlite3가 없으면 그냥 패스 (위의 환경변수만으로도 대부분 해결됨)
    pass
